...
export const Route = createFileRoute("/parafusadeira-furadeira-48v-yuyango4")({
  head: () => ({
    meta: [
      { title: "Parafusadeira Furadeira 48V 2 Baterias com Maleta — Oferta -78%" },
      { name: "description", content: "Parafusadeira Furadeira 48V com 2 baterias, maleta e acessórios completos. Oferta relâmpago com -78% e portes grátis." },
    ],
  }),
...
function ProductPage() {
  ...
  const countdown = useCountdown(3 * 3600 + 51 * 60 + 36);
  const { totalQty: cartQty, add: addToCart } = useCart();
  const PRODUCT_ID = "parafusadeira-48v";
      ...
      <div className="mx-auto max-w-[480px] bg-white pb-24">
        <header className="sticky top-0 z-20 flex items-center gap-2 bg-white px-3 py-2.5 border-b border-gray-100">
          <div className="flex flex-1 items-center gap-2 rounded-full bg-gray-100 px-4 py-2 min-w-0">
            ...
            <span className="truncate whitespace-nowrap text-[15px] text-gray-700">parafusadeira furadeira 48v baterias maleta</span>
          </div>
          <button
            onClick={async () => {
              const shareData = {
                title: "Parafusadeira Furadeira 48V 2 Baterias",
                text: "Olha que oferta na Parafusadeira Furadeira 48V!",
        ...
        <div className="flex items-center justify-center bg-white py-6">
          <img
            src={parafusadeira.url}
            alt="Parafusadeira Furadeira 48V 2 Baterias com Maleta"
            width={1024}
            height={1024}
        ...
        <div className="relative flex items-stretch justify-between overflow-hidden bg-[#FE476C] px-3 pt-2.5 pb-3 text-white">
          ...
          <div className="relative flex flex-col">
            ...
            <div className="ml-[42px] mt-0.5 text-[11px] line-through opacity-90">€ 435,60</div>
          </div>
        ...
        <section className="px-4 pt-4 pb-3 border-b border-gray-100">
          <div className="flex items-start justify-between gap-3">
            <h1 className="text-[17px] font-medium leading-snug text-gray-900">
              Parafusadeira Furadeira 48V 2 Baterias Com Maleta e Acessórios Completo-Yuyango4
            </h1>
          ...
          <div className="mt-2 flex items-center gap-2 text-[13px]">
            ...
            <span className="text-[#1c7ed6]">(345)</span>
            <span className="text-gray-300">|</span>
            <span className="text-gray-500">3478 vendidos</span>
          </div>
        </section>
        ...
        <button onClick={() => setShippingOpen(true)} className="flex w-full items-center gap-3 px-4 py-3 text-left border-b-[6px] border-gray-100">
          ...
          <div className="flex-1">
            ...
            <div className="mt-1 text-[13px] text-gray-700">Receba até 28 de jun</div>
          </div>
        ...
        <section className="px-4 pt-5 pb-4 border-b border-gray-100">
          ...
          >
            <p>
              Parafusadeira e furadeira de impacto 48V de alto desempenho, com 2 baterias de
              lítio de longa duração, maleta resistente para transporte e um kit completo de
              acessórios para todas as suas obras em casa ou no trabalho.
            </p>
            {descOpen && (
              <div className="mt-3 space-y-3">
                <p>
                  Mandril de aperto rápido, ajuste de torque com 18+1 posições, função de
                  impacto para alvenaria e luz LED integrada para trabalhar em locais com pouca
                  iluminação.
                </p>
                <ul className="list-disc space-y-1 pl-5">
                  <li>Tensão: 48V Máx Lithium</li>
                  <li>2 baterias recarregáveis incluídas</li>
                  <li>Maleta de transporte resistente</li>
                  <li>Kit com brocas, bits, soquetes e acessórios</li>
                  <li>Carregador rápido bivolt</li>
                </ul>
              </div>
            )}
            {!descOpen && (
        ...
        <section className="px-4 pt-5 pb-6 border-b border-gray-100">
          ...
          <div className="mt-5 flex items-start gap-6">
            <div className="flex flex-col items-center">
              <div className="text-[40px] font-bold leading-none text-gray-900">4,8</div>
              <div className="mt-2">
          ...
          <div className="mt-6 space-y-5">
            {[
              { initial: "R", name: "Ricardo Pinto", date: "24/06/2026", stars: 5 },
              { initial: "M", name: "Miguel Ferreira", date: "22/06/2026", stars: 5 },
            ].map((rev) => (
