...
export const Route = createFileRoute("/consola-nintendo-switch-2-mario-kart-world")({
  head: () => ({
    meta: [
      { title: "Consola Nintendo Switch 2 + Mario Kart World — Oferta -71%" },
      { name: "description", content: "Consola Nintendo Switch 2 com Mario Kart World (código de descarga incluído). Oferta relâmpago com -71% e portes grátis." },
    ],
  }),
...
function ProductPage() {
  ...
  const countdown = useCountdown(3 * 3600 + 55 * 60 + 23);
  const { totalQty: cartQty, add: addToCart } = useCart();
  const PRODUCT_ID = "switch2-mariokart";
      ...
      <div className="mx-auto max-w-[480px] bg-white pb-24">
        ...
        <header className="sticky top-0 z-20 flex items-center gap-2 bg-white px-3 py-2.5 border-b border-gray-100">
          <div className="flex flex-1 items-center gap-2 rounded-full bg-gray-100 px-4 py-2 min-w-0">
            ...
            <span className="truncate whitespace-nowrap text-[15px] text-gray-700">nintendo switch 2 mario kart world</span>
          </div>
          <button
            onClick={async () => {
              const shareData = {
                title: "Consola Nintendo Switch 2 + Mario Kart World",
                text: "Olha que oferta na Nintendo Switch 2 + Mario Kart World!",
        ...
        <div className="flex items-center justify-center bg-white py-6">
          ...
          <img
            src={switch2.url}
            alt="Consola Nintendo Switch 2 + Mario Kart World"
            width={1024}
            height={1024}
          ...
          <div className="relative flex flex-col">
            <div className="flex items-end gap-1.5">
              ...
              <div className="flex items-end leading-none">
                ...
                <span className="text-[26px] font-extrabold tracking-tight">139,90</span>
              </div>
              <svg
                viewBox="0 0 24 24"
            ...
            <div className="ml-[42px] mt-0.5 text-[11px] line-through opacity-90">€ 489,99</div>
          </div>
        ...
        <button onClick={() => setInstallmentsOpen(true)} className="flex w-full items-center gap-3 border-b border-gray-100 px-4 py-3 text-left">
          ...
          <span className="text-[14px] text-gray-900">
            8x <span className="font-semibold">€ 17,49</span>{" "}
        ...
        <section className="px-4 pt-4 pb-3 border-b border-gray-100">
          <div className="flex items-start justify-between gap-3">
            <h1 className="text-[17px] font-medium leading-snug text-gray-900">
              Consola Nintendo Switch 2 + Jogo Mario Kart World (Código de Descarga na Caixa)
            </h1>
          ...
          <div className="mt-2 flex items-center gap-2 text-[13px]">
            ...
            <span className="text-[#1c7ed6]">(332)</span>
            <span className="text-gray-300">|</span>
            <span className="text-gray-500">5669 vendidos</span>
          </div>
        </section>
        ...
        <section className="px-4 pt-5 pb-4 border-b border-gray-100">
          ...
          >
            <p>
              A nova Consola Nintendo Switch 2 chega com mais potência, ecrã maior e Joy-Con
              renovados. Inclui o jogo Mario Kart World (código de descarga na caixa) para
              começar a jogar imediatamente.
            </p>
            {descOpen && (
              <div className="mt-3 space-y-3">
                <p>
                  Suporta os modos TV, mesa e portátil, com gráficos melhorados, taxas de
                  imagem mais fluidas e compatibilidade com a biblioteca da Switch original.
                </p>
                <p>
                ...
                <ul className="list-disc space:y-1 pl-5">
                  ...
                  <li>Base, adaptador HDMI e carregador</li>
                </ul>
              </div>
            )}
            {!descOpen && (
        ...
        <section className="px-4 pt-5 pb-6 border-b border-gray-100">
          ...
          <div className="mt-6 space-y-5">
            {[
              { initial: "B", name: "Bruno Marques", date: "23/06/2026", stars: 5 },
              { initial: "S", name: "Sofia Ribeiro", date: "21/06/2026", stars: 4 },
            ].map((rev) => (
