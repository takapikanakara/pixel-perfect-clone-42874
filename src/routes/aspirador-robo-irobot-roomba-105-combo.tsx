...
export const Route = createFileRoute("/aspirador-robo-irobot-roomba-105-combo")({
  head: () => ({
    meta: [
      { title: "Aspirador Robô iRobot Roomba 105 Combo — 120 min de Autonomia" },
      { name: "description", content: "Aspirador Robô iRobot Roomba 105 Combo (Preto): aspira e passa pano, 120 min de autonomia. Oferta com -74% e portes grátis." },
    ],
  }),
...
function ProductPage() {
  ...
  const countdown = useCountdown(3 * 3600 + 57 * 60 + 5);
  const { totalQty: cartQty, add: addToCart } = useCart();
  const PRODUCT_ID = "roomba-105";
      ...
      <div className="mx-auto max-w-[480px] bg-white pb-24">
        ...
        <header className="sticky top-0 z-20 flex items-center gap-2 bg-white px-3 py-2.5 border-b border-gray-100">
          <div className="flex flex-1 items-center gap-2 rounded-full bg-gray-100 px-4 py-2 min-w-0">
            ...
            <span className="truncate whitespace-nowrap text-[15px] text-gray-700">aspirador robô irobot roomba 105</span>
          </div>
          <button
            onClick={async () => {
              const shareData = {
                title: "Aspirador Robô iRobot Roomba 105 Combo",
                text: "Olha que oferta no iRobot Roomba 105 Combo!",
        ...
        <div className="flex items-center justify-center bg-white py-6">
          ...
          <img
            src={roomba.url}
            alt="Aspirador Robô iRobot Roomba 105 Combo"
            width={1024}
            height={1024}
          ...
          <div className="relative flex flex-col">
            <div className="flex items-end gap-1.5">
              ...
              <div className="flex items-end leading-none">
                ...
                <span className="text-[26px] font-extrabold tracking-tight">39,00</span>
              </div>
              <svg
                viewBox="0 0 24 24"
            ...
            <div className="ml-[42px] mt-0.5 text-[11px] line-through opacity-90">€ 149,99</div>
          </div>
        ...
        <button onClick={() => setInstallmentsOpen(true)} className="flex w-full items-center gap-3 border-b border-gray-100 px-4 py-3 text-left">
          ...
          <span className="text-[14px] text-gray-900">
            7x <span className="font-semibold">€ 5,57</span>{" "}
        ...
        <section className="px-4 pt-4 pb-3 border-b border-gray-100">
          <div className="flex items-start justify-between gap-3">
            <h1 className="text-[17px] font-medium leading-snug text-gray-900">
              Aspirador Robô IROBOT Roomba 105 Combo (Autonomia: 120 min - Preto)
            </h1>
          ...
          <div className="mt-2 flex items-center gap-2 text-[13px]">
            ...
            <span className="text-[#1c7ed6]">(267)</span>
            <span className="text-gray-300">|</span>
            <span className="text-gray-500">3789 vendidos</span>
          </div>
        </section>
        ...
        <section className="px-4 pt-5 pb-4 border-b border-gray-100">
          ...
          >
            <p>
              O Aspirador Robô iRobot Roomba 105 Combo aspira e passa pano numa só
              passagem, com até 120 minutos de autonomia. Controlo total pela app iRobot
              Home, navegação inteligente e design discreto em preto.
            </p>
            {descOpen && (
              <div className="mt-3 space-y-3">
                <p>
                  Sistema 2 em 1 com escovas multi-superfície e mopa para pavimentos duros.
                  Sensores anti-queda, deteção de obstáculos e regresso automático à base
                  de carregamento.
                </p>
                <p>
                  Compatível com Alexa e Google Assistant. Configure rotinas, zonas
                  proibidas e horários diretamente do telemóvel. Ideal para casas com
                  vários tipos de pavimento.
                </p>
                <ul className="list-disc space-y-1 pl-5">
                  <li>Autonomia até 120 minutos</li>
                  <li>Aspira e passa pano numa só passagem</li>
                  <li>App iRobot Home + assistentes de voz</li>
                  <li>Regresso automático à base</li>
                </ul>
              </div>
            )}
            {!descOpen && (
        ...
        <section className="px-4 pt-5 pb-6 border-b border-gray-100">
          ...
          <div className="mt-5 flex items-start gap-6">
            <div className="flex flex-col items-center">
              <div className="text-[40px] font-bold leading-none text-gray-900">4,0</div>
              <div className="mt-2">
          ...
          <div className="mt-6 space-y-5">
            {[
              { initial: "C", name: "Carla Sousa", date: "23/06/2026", stars: 4 },
              { initial: "P", name: "Pedro Almeida", date: "20/06/2026", stars: 5 },
            ].map((rev) => (
