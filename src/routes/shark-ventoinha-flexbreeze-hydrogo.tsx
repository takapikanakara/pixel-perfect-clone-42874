...
import flexbreeze from "@/assets/shark-flexbreeze.jpg.asset.json";
import shareIcon from "@/assets/share-icon.png.asset.json";

export const Route = createFileRoute("/shark-ventoinha-flexbreeze-hydrogo")({
  head: () => ({
    meta: [
      { title: "Shark Ventoinha de Chão FLEXBREEZE HydroGo — Portátil e Potente" },
      { name: "description", content: "Shark Ventoinha de Chão FLEXBREEZE HydroGo: portátil, sem fios e resistente. Oferta com -66% e portes grátis." },
    ],
  }),
...
function ProductPage() {
  ...
  const PRODUCT_ID = "shark-flexbreeze";
      ...
      <div className="mx-auto max-w-[480px] bg-white pb-24">
        ...
        <header className="sticky top-0 z-20 flex items-center gap-2 bg-white px-3 py-2.5 border-b border-gray-100">
          <div className="flex flex-1 items-center gap-2 rounded-full bg-gray-100 px-4 py-2 min-w-0">
            ...
            <span className="truncate whitespace-nowrap text-[15px] text-gray-700">shark ventoinha flexbreeze hydrogo</span>
          </div>
          <button
            onClick={async () => {
              const shareData = {
                title: "Shark Ventoinha de Chão FLEXBREEZE HydroGo",
                text: "Olha que oferta na Shark FLEXBREEZE HydroGo!",
        ...
        <div className="flex items-center justify-center bg-white py-6">
          ...
          <img
            src={flexbreeze.url}
            alt="Shark Ventoinha de Chão FLEXBREEZE HydroGo"
            width={1024}
            height={1024}
        ...
        <div className="relative flex items-stretch justify-between overflow-hidden bg-[#FE476C] px-3 pt-2.5 pb-3 text-white">
          ...
          <div className="relative flex flex-col">
            ...
            <div className="ml-[42px] mt-0.5 text-[11px] line-through opacity-90">€ 113,91</div>
          </div>
        ...
        <button onClick={() => setInstallmentsOpen(true)} className="flex w-full items-center gap-3 border-b border-gray-100 px-4 py-3 text-left">
          ...
          <span className="text-[14px] text-gray-900">
            8x <span className="font-semibold">€ 4,88</span>{" "}
        ...
        <section className="px-4 pt-4 pb-3 border-b border-gray-100">
          <div className="flex items-start justify-between gap-3">
            <h1 className="text-[17px] font-medium leading-snug text-gray-900">
              Shark Ventoinha de Chão FLEXBREEZE HydroGo — Portátil sem Fios
            </h1>
          ...
          <div className="mt-2 flex items-center gap-2 text-[13px]">
            ...
            <span className="text-[#1c7ed6]">(443)</span>
            <span className="text-gray-300">|</span>
            <span className="text-gray-500">2365 vendidos</span>
          </div>
        </section>
        ...
        <section className="px-4 pt-5 pb-4 border-b border-gray-100">
          ...
          >
            <p>
              A Shark Ventoinha de Chão FLEXBREEZE HydroGo combina potência, portabilidade e
              resistência à água numa só ventoinha. Ideal para dentro e fora de casa, oferece
              brisa intensa onde quer que esteja.
            </p>
            {descOpen && (
              <div className="mt-3 space-y-3">
                <p>
                  Funciona com fios ou bateria recarregável até 12 horas de uso. Resistente a
                  salpicos (IPX4), perfeita para usar no jardim, varanda, garagem ou em casa.
                </p>
                <p>
                  Design compacto com pega ergonómica para transporte fácil. Múltiplas
                  velocidades, oscilação ajustável e modo brisa natural para conforto
                  máximo em qualquer ambiente.
                </p>
                <ul className="list-disc space-y-1 pl-5">
                  <li>Bateria recarregável até 12h</li>
                  <li>Resistência à água IPX4</li>
                  <li>Múltiplas velocidades e modo brisa</li>
                  <li>Leve e portátil com pega integrada</li>
                </ul>
              </div>
            )}
            {!descOpen && (
        ...
        <section className="px-4 pt-5 pb-6 border-b border-gray-100">
          ...
          <div className="mt-6 space-y-5">
            {[
              { initial: "I", name: "Inês Carvalho", date: "23/06/2026", stars: 5 },
              { initial: "T", name: "Tiago Fernandes", date: "21/06/2026", stars: 4 },
            ].map((rev) => (
