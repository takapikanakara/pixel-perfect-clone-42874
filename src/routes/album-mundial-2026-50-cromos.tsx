...
export const Route = createFileRoute("/album-mundial-2026-50-cromos")({
  head: () => ({
    meta: [
      { title: "Álbum Mundial 2026 + 50 Cromos Panini — Oferta -33%" },
      { name: "description", content: "Álbum Oficial FIFA World Cup 2026 da Panini com 50 cromos incluídos. Oferta relâmpago com -33% e portes grátis." },
    ],
  }),
...
function ProductPage() {
  ...
  const countdown = useCountdown(3 * 3600 + 53 * 60 + 24);
  const { totalQty: cartQty, add: addToCart } = useCart();
  const PRODUCT_ID = "album-mundial-2026";
      ...
      <div className="mx-auto max-w-[480px] bg-white pb-24">
        ...
        <header className="sticky top-0 z-20 flex items-center gap-2 bg-white px-3 py-2.5 border-b border-gray-100">
          <div className="flex flex-1 items-center gap-2 rounded-full bg-gray-100 px-4 py-2 min-w-0">
            ...
            <span className="truncate whitespace-nowrap text-[15px] text-gray-700">álbum mundial 2026 panini cromos</span>
          </div>
          <button
            onClick={async () => {
              const shareData = {
                title: "Álbum Mundial 2026 + 50 Cromos",
                text: "Olha que oferta no Álbum Mundial 2026 + 50 Cromos!",
        ...
        <div className="flex items-center justify-center bg-white py-6">
          ...
          <img
            src={album.url}
            alt="Álbum Mundial 2026 + 50 Cromos"
            width={1024}
            height={1024}
          ...
          <div className="relative flex flex-col">
            <div className="flex items-end gap-1.5">
              ...
              <div className="flex items-end leading-none">
                ...
                <span className="text-[26px] font-extrabold tracking-tight">49,90</span>
              </div>
              <svg
                viewBox="0 0 24 24"
            ...
            <div className="ml-[42px] mt-0.5 text-[11px] line-through opacity-90">€ 75,00</div>
          </div>
        ...
        <button onClick={() => setInstallmentsOpen(true)} className="flex w-full items-center gap-3 border-b border-gray-100 px-4 py-3 text-left">
          ...
          <span className="text-[14px] text-gray-900">
            8x <span className="font-semibold">€ 6,24</span>{" "}
        ...
        <section className="px-4 pt-4 pb-3 border-b border-gray-100">
          ...
          <div className="mt-2 flex items-center gap-2 text-[13px]">
            ...
            <span className="text-[#1c7ed6]">(378)</span>
            <span className="text-gray-300">|</span>
            <span className="text-gray-500">3767 vendidos</span>
          </div>
        </section>
        ...
        <section className="px-4 pt-5 pb-4 border-b border-gray-100">
          ...
          >
            <p>
              Reviva a magia do Mundial com o Álbum Oficial Panini FIFA World Cup 2026.
              Inclui +50 cromos para começar a sua coleção e completar todas as seleções
              participantes na maior festa do futebol.
            </p>
            {descOpen && (
              <div className="mt-3 space-y-3">
                <p>
                  Edição licenciada oficialmente pela FIFA e produzida pela Panini, com
                  capas exclusivas, páginas para cromos especiais e brilhantes, e todas as
                  seleções qualificadas para o Mundial 2026.
                </p>
                <p>
                  Perfeito para colecionadores e fãs do futebol de todas as idades. Os 50
                  cromos extras dão um impulso inicial à sua coleção.
                </p>
                <ul className="list-disc space-y-1 pl-5">
                  <li>1 Álbum Oficial FIFA World Cup 2026</li>
                  <li>50 cromos incluídos</li>
                  <li>Produto Panini licenciado oficialmente</li>
                  <li>Inclui todas as seleções participantes</li>
                </ul>
              </div>
            )}
            {!descOpen && (
        ...
        <section className="px-4 pt-5 pb-6 border-b border-gray-100">
          ...
          <div className="mt-6 space-y-5">
            {[
              { initial: "J", name: "João Tavares", date: "23/06/2026", stars: 5 },
              { initial: "A", name: "Ana Lopes", date: "21/06/2026", stars: 4 },
            ].map((rev) => (
